...
if __name__ == "__main__":
    ...
    parser.add_argument('--ff_quant', action='store_true', help="evaluate accurate computation")
    ...
    parser.add_argument('--eval_compressor', action='store_true', help="evaluate msb compensation computation")
    parser.add_argument('--inlier', action='store_true', help="evaluate msb compensation computation")                      # F3 Offloading
    parser.add_argument('--bit_sparsity', action='store_true', help="evaluate msb compensation computation")                # F2 I/W Switching
