...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', action='store_true', help="use fixed point err quantization")
    ...
    ### SR Quantization
    parser.add_argument('--w_fxp', action='store_true', help="use fixed point quantization")
    parser.add_argument('--w_fxp_bw', type=int, default=8, help="default fixed point bit width")
    parser.add_argument('--i_fxp', action='store_true', help="use fixed point quantization")
