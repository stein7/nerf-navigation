...
if __name__ == "__main__":
    ...
    parser.add_argument('--approx', action='store_true', help="simulate approx simulation, weight/input bit sparsity")
    parser.add_argument('--compressor_accuracy', action='store_true', help="compressor based AT accuracy")
    parser.add_argument('--at_fan_in', type=int, default=32, help="compressor based at fan in")
