...
## nerf-navigation-feature-perf-v1
class NeRFNetwork(NeRFRenderer):
    def __init__(self,
        ...
        self.opt = opt
        self.fxp = self.opt.fxp
        self.fxp_bw = self.opt.fxp_bw
            ...
            if l==0 :
                ...
                if self.opt.approx:
                    for bg in range (bg_num):
                        ...
                        weight_bin = dec2bin(weight_q.int(), 4)                         ## get binary weight @ weight quantization
                        ...
                        input_bin = dec2bin( input_quantized, 4 )
