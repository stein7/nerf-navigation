...
class Planner:
    ...
    def get_bitmapInWay(self, coods, sigma, coods_BP, num_ways):
        ...
        return coods_z_proj, sigma_edge_idx
    def test_BP_approx(self, coods_z_proj, sigma_edge_idx):
    ...
    def get_state_cost(self):
        ...
        coods_z_proj, sigma_edge_idx = self.get_bitmapInWay(coods, sigma, coods_BP, num_ways)
        # Way, Layer별로 nvec와의 cos sim 값을 출력 (input : Layer, Way, edge idx)
        self.test_BP_approx(coods_z_proj, sigma_edge_idx)
