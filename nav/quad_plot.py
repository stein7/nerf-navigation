...
class Planner:
    ...
    def dh_learn_init(self):
        ...
        try:
            ...
            # perpendicular_vector[2] = -0.06
            # perpendicular_vector = torch.tensor([direction_vector[1], -direction_vector[0], direction_vector[2], device='cuda', dtype=torch.float32)
            ...
            # directions = {} # index에 대한 딕셔너리로 호출용이
            directions = {}
            directions = self.dh_direction(indices, direction_vector, perpendicular_vector, dirvec, perpvec)
