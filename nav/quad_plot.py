...
class Planner:
    ...
    def a_star_init(self, plan_mode=None, model=None, approx=False):
        ...
        if self.opt.eval_ich_range:
            self.sr_eval_ich_range( coods , model ) 
...
################################################################################################################
    ...
    def sr_compressor_accuracy(self, coord, model, accurate_output):
        ...
        print(f'Occupied Accuracy: {(a_star_occupied==golden_a_star_occupied).sum()/a_star_sigma.shape[0]/a_star_sigma.shape[1]/a_star_sigma.shape[2]}')
