...
def simulate(planner_cfg, agent_cfg, filter_cfg, extra_cfg, density, density_fn, density_prun_fn, render_fn, get_rays_fn):
    ...
    traj = Planner(start_state, end_state, planner_cfg, density, density_fn, density_prun_fn)
...
if __name__ == "__main__":
    ...
    ### SR Custom 
    parser.add_argument('--fxp_bw', type=int, default=8 )       # opt.fxp_bw
    parser.add_argument('--fxp', action='store_true' )          # opt.fxp
