...
def astar_v2(occupied, start, goal, density_fn, robot_body, side):
...
def astar_v3(occupied, start, goal, density_fn, robot_body, side, dataset, opt):
...
def astar_extend(occupied, start, goal, density_fn, robot_body, side, z_bound, dataset, opt):
...
def astar_2d(occupied, start, goal):
    def heuristic(a, b):
