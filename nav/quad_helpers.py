...
def astar(occupied, start, goal, density_fn, robot_body, side, z_bound, dataset, opt):
    ...
    if not edit: print(f'Original A* Ignore Body Points')
    else: print(f'Edit A* Consider Body Points')
